...
function switchLang() {
  ...
  `;
    ...
    document.getElementById("timeline").innerHTML = `
      ...
      <div class="timeline-item"><div class="timeline-date">2024.12 – 2025.08</div><div class="timeline-content"><strong>社媒运营实习生 @ 易思汇</strong><br/>独立运营哥大校园相关小红书账号，聚焦政策解读与校园热点。学期内每周发布视觉内容并优化标题与标签，提升留存率。单条地铁卡更新贴2小时破万浏览，账号总浏览达45,000+。</div></div>
